      ...
      <div className="relative z-10 p-3 md:p-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-shrink-0 w-32 md:w-40">
            <div className="grid grid-cols-2 gap-1">
              {products.map((product, index) => (
                <div 
                  key={index}
                  className="aspect-square rounded overflow-hidden bg-background/80 backdrop-blur-sm border border-nature-gold/30"
                  style={{ 
          ...
          <div className="flex-1 text-left">
            ...
            <div className="text-xl md:text-2xl font-display font-black text-nature-gold drop-shadow-lg mb-1">
              20% OFF
            </div>
